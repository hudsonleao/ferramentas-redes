...
<html lang="pt-br">
    ...
    <body>
        ...
        <section class="main-content">
                <div class="uk-card uk-text-center uk-card-large uk-background-muted uk-card-body">
                    <h1>PING</h1><br>
                    ...
                    if (isset($_POST['formulario'])) {
                        ...
                        $quant = count($output);
                        echo 'Ping para o host:<p style="font-size:30px; color:blue;">' . $host . '</p>';
                        echo '<div class="container uk-text-small">'
